...
/** Exact CSS from Figma 🧱 Elevations usage labels. */
const LEVELS = [
  {
    name: 'None',
    token: 'none',
    ...
    css: 'none',
    usage: 'Flat elements, no depth (inline content)',
  },
  {
    name: 'Low',
    token: 'low',
    ...
    usage: 'Subtle lift for cards, list items on hover',
  },
  {
    name: 'Medium',
    token: 'medium',
    ...
    usage: 'Floating elements like dropdowns, popovers',
  },
  {
    name: 'High',
    token: 'high',
  ...
  },
  {
    ...
    usage: 'Toast messages, notifications, top-layer elements',
  },
] as const
...
const meta: Meta = {
  ...
  parameters: {
    docs: {
      description: {
        component: 'Figma **🧱 Elevations** — exact shadow strings from the file.',
      },
    },
  },
}
