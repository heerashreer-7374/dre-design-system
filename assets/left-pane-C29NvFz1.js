import{i as g,a as m,b as h}from"./iframe-BMlSAenk.js";import{n as d,t as v}from"./property-DjCj8DcD.js";import{h as y}from"./styles-CNCx_--U.js";import"./icon-DC5KmofD.js";import"./accordion-ZyoOmXCc.js";import"./accordion-group-BYHDU8xg.js";var w=Object.defineProperty,z=Object.getOwnPropertyDescriptor,x=t=>{throw TypeError(t)},o=(t,e,i,l)=>{for(var s=l>1?void 0:l?z(e,i):e,f=t.length-1,u;f>=0;f--)(u=t[f])&&(s=(l?u(e,i,s):u(s))||s);return l&&s&&w(e,i,s),s},_=(t,e,i)=>e.has(t)||x("Cannot "+i),$=(t,e,i)=>e.has(t)?x("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),n=(t,e,i)=>(_(t,e,"access private method"),i),a,b,c,p;let r=class extends m{constructor(){super(...arguments),$(this,a),this.mode="code-editor",this.state="extended",this.separated=!1,this.headerTitle="Actions",this.railIcons=[],this.railTopIcons=["syntax","cable"],this.railBottomIcons=["more","layout"]}render(){const t=this.railIcons.length?this.railIcons:this.railTopIcons,e=this.railIcons.length?[]:this.railBottomIcons;return h`
