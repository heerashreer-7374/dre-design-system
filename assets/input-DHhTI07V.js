import{i as f,a as v,b as n}from"./iframe-BIGdDvVp.js";import{n as o,t as b}from"./property-_7csjOJC.js";import{h as m}from"./styles-DjfhIa7o.js";var y=Object.defineProperty,x=Object.getOwnPropertyDescriptor,u=i=>{throw TypeError(i)},s=(i,e,r,a)=>{for(var l=a>1?void 0:a?x(e,r):e,d=i.length-1,p;d>=0;d--)(p=i[d])&&(l=(a?p(e,r,l):p(l))||l);return a&&l&&y(e,r,l),l},g=(i,e,r)=>e.has(i)||u("Cannot "+r),_=(i,e,r)=>e.has(i)?u("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(i):e.set(i,r),$=(i,e,r)=>(g(i,e,"access private method"),r),h,c;let t=class extends v{constructor(){super(...arguments),_(this,h),this.size="medium",this.label="",this.placeholder="",this.value="",this.name="",this.type="text",this.hint="",this.disabled=!1,this.required=!1,this.invalid=!1,this.destructive=!1,this.focused=!1}willUpdate(){this.destructive&&(this.invalid=!0)}render(){return n`
