import{b as r}from"./iframe-GA3ktVQc.js";import"./button-CFNMCiNm.js";import"./icon-Btw80okq.js";import"./preload-helper-Dp1pzeXC.js";import"./property-rkDd5alT.js";import"./styles-_scQb5lY.js";const X={title:"Single Components/Button",component:"dre-button",tags:["autodocs"],argTypes:{hierarchy:{control:"select",options:["primary","secondary","ghost"]},size:{control:"select",options:["xsmall","small","medium"]},icon:{control:"select",options:["false","leading","trailing","only"]},disabled:{control:"boolean"},destructive:{control:"boolean"}},args:{hierarchy:"primary",size:"medium",icon:"false",disabled:!1,destructive:!1,label:"Button"},parameters:{docs:{description:{component:"Figma **⭐ Button** (`12002:17139`) — Hierarchy · Size · State · Icon. Heights: Medium 30 · Small 26 · XSmall 24."}}}},n={render:e=>r`
    <dre-button
  ...
  \`
}`,...(S=(f=o.parameters)==null?void 0:f.docs)==null?void 0:S.source}}};var w,F,k;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...
  \`
}`,...(k=(F=s.parameters)==null?void 0:F.docs)==null?void 0:k.source}}};const G=["Default","Hierarchy","Sizes","Icons","States","Matrix"];export{n as Default,t as Hierarchy,i as Icons,s as Matrix,a as Sizes,o as States,G as __namedExportsOrder,X as default};
