import{b as i}from"./iframe-GA3ktVQc.js";import"./input-DEXSmfB2.js";import"./icon-Btw80okq.js";import"./preload-helper-Dp1pzeXC.js";import"./property-rkDd5alT.js";import"./styles-_scQb5lY.js";const x={title:"Single Components/Input Field",component:"dre-input",tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium"]},disabled:{control:"boolean"},invalid:{control:"boolean"},destructive:{control:"boolean"}},args:{size:"medium",label:"Email",placeholder:"Add Value",hint:"",disabled:!1,invalid:!1,destructive:!1},parameters:{docs:{description:{component:"Figma **⭐ Input Field** (`10209:416`) — Small h24 · Medium h34 · radius 4 · stroke `#bdc0cf`."}}}},l={render:e=>i`
    <dre-input
      size=${e.size}
      label=${e.label}
  ...
  \`
}`,...(m=(c=a.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};const z=["Default","Sizes","States"];export{l as Default,d as Sizes,a as States,z as __namedExportsOrder,x as default};
