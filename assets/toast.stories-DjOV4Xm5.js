import{b as i}from"./iframe-CxxUV_ql.js";import"./toast-DfQ3rBLK.js";import{f as m}from"./figma-By0ClEEC.js";import"./preload-helper-Dp1pzeXC.js";import"./property-BAmm2Bkg.js";import"./styles-DnIXmjyS.js";import"./icon-DJMhDlAD.js";const h={title:"Single Components/Toast Message",component:"dre-toast",tags:["autodocs"],argTypes:{type:{control:"select",options:["success","warning","error","info"]}},args:{type:"success",message:"All your changes have been saved"},parameters:{docs:{description:{component:`Figma **⭐ Toast Message** ${m("10110:280")} — 314×48 · pad 16 · radius 4 · Success/Warning/Error/Info fills.`}}}},e={render:t=>i`<dre-toast type=${t.type} message=${t.message}></dre-toast>`},s={name:"Features / Types",render:()=>i`
  ...
  \`
}`,...(p=(d=s.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};const w=["Default","Types"];export{e as Default,s as Types,w as __namedExportsOrder,h as default};
