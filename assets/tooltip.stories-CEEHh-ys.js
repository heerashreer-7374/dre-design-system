import{i as $,a as j,b as r}from"./iframe-CxxUV_ql.js";import{n as p,t as S}from"./property-BAmm2Bkg.js";import{h as _}from"./styles-DnIXmjyS.js";import"./button-BJBZnisn.js";import{f as A}from"./figma-By0ClEEC.js";import"./preload-helper-Dp1pzeXC.js";var D=Object.defineProperty,P=Object.getOwnPropertyDescriptor,n=(t,a,d,i)=>{for(var e=i>1?void 0:i?P(a,d):a,m=t.length-1,f;m>=0;m--)(f=t[m])&&(e=(i?f(a,d,e):f(e))||e);return i&&e&&D(a,d,e),e};let o=class extends j{constructor(){super(...arguments),this.content="",this.supportingText="",this.arrow="none",this.placement="bottom",this.open=!1}render(){return r`
      <slot></slot>
    ...
    `];n([p()],o.prototype,"content",2);n([p({attribute:"supporting-text"})],o.prototype,"supportingText",2);n([p({reflect:!0})],o.prototype,"arrow",2);n([p({reflect:!0})],o.prototype,"placement",2);n([p({type:Boolean,reflect:!0})],o.prototype,"open",2);o=n([S("dre-tooltip")],o);const H={title:"Single Components/Tooltip",component:"dre-tooltip",tags:["autodocs"],argTypes:{arrow:{control:"select",options:["none","bottom-center","bottom-left","bottom-right","top-center","top-left","top-right"]}},args:{content:"This is a tooltip",supportingText:"",arrow:"bottom-center"},parameters:{docs:{description:{component:`Figma **⭐ Tooltip** ${A("12055:2105")} — pad 12×8 · radius 4 · bg \`#1b1b1e\` · optional supporting text + arrow.`}}}},s={render:t=>r`
  ...
  `};var h,u,g;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: args => html\`
    <div style="padding:80px;display:flex;justify-content:center;">
      <dre-tooltip
  ...
  \`
}`,...(g=(u=s.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};var b,w,x;l.parameters={...l.parameters,docs:{...(b=l.parameters)==null?void 0:b.docs,source:{originalSource:`{
  ...
  \`
}`,...(T=(v=c.parameters)==null?void 0:v.docs)==null?void 0:T.source}}};const K=["Default","WithSupportingText","Arrows"];export{c as Arrows,s as Default,l as WithSupportingText,K as __namedExportsOrder,H as default};
