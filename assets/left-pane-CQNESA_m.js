import{i as x,a as m,b as f}from"./iframe-6U_684zG.js";import{n,t as g}from"./property-Bwn_HGw6.js";import{h as v}from"./styles-Cq6U1Hym.js";import"./icon-BCYjMvUl.js";import"./block-item-9l10tRoX.js";import"./accordion-group-_L4Je3f2.js";var y=Object.defineProperty,w=Object.getOwnPropertyDescriptor,u=t=>{throw TypeError(t)},o=(t,e,i,s)=>{for(var a=s>1?void 0:s?w(e,i):e,p=t.length-1,h;p>=0;p--)(h=t[p])&&(a=(s?h(e,i,a):h(a))||a);return s&&a&&y(e,i,a),a},_=(t,e,i)=>e.has(t)||u("Cannot "+i),z=(t,e,i)=>e.has(t)?u("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),d=(t,e,i)=>(_(t,e,"access private method"),i),l,b,c;let r=class extends m{constructor(){super(...arguments),z(this,l),this.mode="code-editor",this.state="extended",this.separated=!1,this.headerTitle="Actions",this.railIcons=[],this.railTopIcons=["syntax","cable"],this.railBottomIcons=["more","layout"]}render(){const t=this.railIcons.length?this.railIcons:this.railTopIcons,e=this.railIcons.length?[]:this.railBottomIcons;return f`
