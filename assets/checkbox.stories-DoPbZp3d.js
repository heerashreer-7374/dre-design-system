import{b as a}from"./iframe-D98_Yrru.js";import"./checkbox-CCafw0jB.js";import"./preload-helper-BJOJroOC.js";import"./property-OxoNfEB1.js";import"./styles-CTqCNxHK.js";const g={title:"Single Components/Checkbox",component:"dre-checkbox",tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium"]},checked:{control:"boolean"},disabled:{control:"boolean"},indeterminate:{control:"boolean"}},args:{size:"medium",checked:!1,disabled:!1,indeterminate:!1},parameters:{docs:{description:{component:"Figma **⭐ Checkbox** (`10048:396`) — Small 8×8 r2 · Medium 14×14 r4 · Selected `#0d6dfd`."}}}},c={render:e=>a`
    <dre-checkbox
      size=${e.size}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
  ...
  \`
}`,...(h=(b=r.parameters)==null?void 0:b.docs)==null?void 0:h.source}}};const z=["Default","Sizes","States"];export{c as Default,d as Sizes,r as States,z as __namedExportsOrder,g as default};
