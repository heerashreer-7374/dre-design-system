import{i as g,a as m,b as h}from"./iframe-BIGdDvVp.js";import{n as d,t as v}from"./property-_7csjOJC.js";import{h as y}from"./styles-DjfhIa7o.js";import"./icon-BKdMMQwy.js";import"./accordion-BdmyCjX_.js";import"./accordion-group-D2wQdFY8.js";var w=Object.defineProperty,z=Object.getOwnPropertyDescriptor,x=t=>{throw TypeError(t)},o=(t,e,i,l)=>{for(var s=l>1?void 0:l?z(e,i):e,f=t.length-1,u;f>=0;f--)(u=t[f])&&(s=(l?u(e,i,s):u(s))||s);return l&&s&&w(e,i,s),s},_=(t,e,i)=>e.has(t)||x("Cannot "+i),$=(t,e,i)=>e.has(t)?x("Cannot add the same private member more than once"):e instanceof WeakSet?e.add(t):e.set(t,i),n=(t,e,i)=>(_(t,e,"access private method"),i),a,b,c,p;let r=class extends m{constructor(){super(...arguments),$(this,a),this.mode="code-editor",this.state="extended",this.separated=!1,this.headerTitle="Actions",this.railIcons=[],this.railTopIcons=["syntax","cable"],this.railBottomIcons=["more","layout"]}render(){const t=this.railIcons.length?this.railIcons:this.railTopIcons,e=this.railIcons.length?[]:this.railBottomIcons;return h`
      <nav class="rail" part="rail" aria-label="Left pane tools">
        <div class="rail-group">${n(this,a,c).call(this,t,!0)}</div>
        <div class="rail-spacer" aria-hidden="true"></div>
        ${e.length?h`
              ${n(this,a,c).call(this,e.slice(0,1))}
              <div class="rail-divider" aria-hidden="true"></div>
              ${n(this,a,c).call(this,e.slice(1))}
            `:null}
      </nav>
            ...
            <dre-accordion-group exclusive>
              <dre-accordion title="Basics" expanded>
                ...
                <div class="snippet-list">
                  ${n(this,a,p).call(this,"Set Variable","assign values to fields","code")}
                  ${n(this,a,p).call(this,"Set Field Value","assign values to fields","cioption")}
                  ${n(this,a,p).call(this,"Call Function","assign values to fields","function-square")}
                </div>
              </dre-accordion>
    ...
    `}};a=new WeakSet;b=function(){this.state=this.state==="extended"?"collapsed":"extended",this.dispatchEvent(new CustomEvent("dre-collapse-change",{detail:{state:this.state},bubbles:!0,composed:!0}))};c=function(t,e=!1){return t.map((i,l)=>h`
        <button
          class="rail-btn"
          type="button"
          aria-current=${e&&l===0?"true":"false"}
          title=${i}
          @click=${()=>{i==="layout"&&n(this,a,b).call(this)}}
        >
          <dre-icon name=${i} size="20"></dre-icon>
        </button>
      `)};p=function(t,e,i){return h`
      <div class="snippet">
