import{b as a}from"./iframe-BfQCnnR_.js";import"./checkbox-Clpdb_Ie.js";import"./preload-helper-Dp1pzeXC.js";import"./property-P_7FsvOw.js";import"./styles-Bjo1gRn0.js";const g={title:"Single Components/Checkbox",component:"dre-checkbox",tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium"]},checked:{control:"boolean"},disabled:{control:"boolean"},indeterminate:{control:"boolean"}},args:{size:"medium",checked:!1,disabled:!1,indeterminate:!1},parameters:{docs:{description:{component:"Figma **⭐ Checkbox** (`10048:396`) — Small 8×8 r2 · Medium 14×14 r4 · Selected `#0d6dfd`."}}}},c={render:e=>a`
    <dre-checkbox
      size=${e.size}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
