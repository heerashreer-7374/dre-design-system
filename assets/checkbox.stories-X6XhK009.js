import{b as a}from"./iframe-CxxUV_ql.js";import"./checkbox-BVuUnpjP.js";import{f as k}from"./figma-By0ClEEC.js";import"./preload-helper-Dp1pzeXC.js";import"./property-BAmm2Bkg.js";import"./styles-DnIXmjyS.js";const z={title:"Single Components/Checkbox",component:"dre-checkbox",tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium"]},checked:{control:"boolean"},disabled:{control:"boolean"},indeterminate:{control:"boolean"}},args:{size:"medium",checked:!1,disabled:!1,indeterminate:!1},parameters:{docs:{description:{component:`Figma **⭐ Checkbox** ${k("10048:396")} — Small 8×8 r2 · Medium 14×14 r4 · Selected \`#0d6dfd\`.`}}}},c={render:e=>a`
    <dre-checkbox
      size=${e.size}
      ?checked=${e.checked}
      ?disabled=${e.disabled}
