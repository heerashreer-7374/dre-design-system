import{b as r}from"./iframe-D98_Yrru.js";import"./button-xVVvOKBv.js";import"./icon-B1KlDiLz.js";import"./preload-helper-BJOJroOC.js";import"./property-OxoNfEB1.js";import"./styles-CTqCNxHK.js";const X={title:"Single Components/Button",component:"dre-button",tags:["autodocs"],argTypes:{hierarchy:{control:"select",options:["primary","secondary","ghost"]},size:{control:"select",options:["xsmall","small","medium"]},icon:{control:"select",options:["false","leading","trailing","only"]},disabled:{control:"boolean"},destructive:{control:"boolean"}},args:{hierarchy:"primary",size:"medium",icon:"false",disabled:!1,destructive:!1,label:"Button"},parameters:{docs:{description:{component:"Figma **⭐ Button** (`12002:17139`) — Hierarchy · Size · State · Icon. Heights: Medium 30 · Small 26 · XSmall 24."}}}},n={render:e=>r`
    <dre-button
