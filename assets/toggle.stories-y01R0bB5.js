import{b as s}from"./iframe-GA3ktVQc.js";import"./toggle-DYL-39Z4.js";import"./preload-helper-Dp1pzeXC.js";import"./property-rkDd5alT.js";import"./styles-_scQb5lY.js";const k={title:"Single Components/Toggle",component:"dre-toggle",tags:["autodocs"],argTypes:{size:{control:"select",options:["small","medium"]},checked:{control:"boolean"},disabled:{control:"boolean"}},args:{size:"medium",checked:!0,disabled:!1},parameters:{docs:{description:{component:"Figma **⭐ Toggle** (`10070:229`) — Small 26×18 · Medium 32×22 · On `#0d6dfd` · Off `#bdc0cf`."}}}},e={render:t=>s`
  ...
  \`
}`,...(p=(m=r.parameters)==null?void 0:m.docs)==null?void 0:p.source}}};const z=["Default","Sizes","States"];export{e as Default,d as Sizes,r as States,z as __namedExportsOrder,k as default};
